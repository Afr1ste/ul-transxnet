...
REQUIRED_PATHS = [
    ...
    "results/provenance_release_20260510/predictions/recomputed_paperlog_labels/main_benchmark_table_recomputed.csv",
    "results/provenance_release_20260510/predictions/recomputed_paperlog_labels/original_transxnet_delta_recomputed.csv",
    "results/provenance_release_20260510/predictions/recomputed_paperlog_labels/full_complexity_pool_recomputed.csv",
    ...
    "results/provenance_release_20260510/predictions/recomputed_paperlog_labels/label_mismatch_audit.csv",
    ...
    "scripts/update_paperlog_complexity_figures.py",

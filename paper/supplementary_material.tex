...
Important interim status: supplementary rows sourced from historical prediction CSVs recomputed with the frozen paper-log labels are audit-only until the matching strict end-to-end reruns are complete. They are kept to document label drift and provenance, not as final submission-ready evidence.

...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lccccccccc}
        ...
        RepViT-M1.1 & 256 & 8.04M & 1.80G & 5.19 & 0.8403 & 0.8028 & 0.6797 & 0.7743 & 0.7020 \\
        UL-TransXNet & 256 & 14.37M & 2.36G & 30.23 & 0.9483 & \textbf{0.8998} & \textbf{0.8767} & \textbf{0.9083} & \textbf{0.8296} \\
        ...
        ConvNeXt-Tiny & 256 & 28.21M & 5.82G & 3.30 & \textbf{0.9508} & 0.8050 & 0.8274 & 0.8611 & 0.7651 \\
...
\begin{table}[!htbp]
    \centering
    \small
    \caption{Offline paired statistical comparison between UL-TransXNet and the strongest comparison baseline in the main benchmark table. These are repeated-run stability checks, not large-sample clinical significance tests.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{llcccc}
        ...
        \midrule
        BUSI & oracle & 0.8998 & 0.7961 & 0.8018 & 0.8140 \\
        BUSI & auto & 0.8725 & 0.7839 & 0.7893 & 0.8031 \\
        BUSI & full & 0.7737 & 0.6982 & 0.6915 & 0.7023 \\
        AUL & oracle & 0.8767 & 0.8200 & 0.7462 & 0.7685 \\
        AUL & auto & 0.8507 & 0.7593 & 0.6908 & 0.7165 \\
        AUL & full & 0.7441 & 0.6805 & 0.6787 & 0.7512 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
\end{table}
...
\begin{table}[!htbp]
    \centering
    \small
    \caption{Seed/fold-level uncertainty and calibration summary for UL-TransXNet on the original main test sets. ECE uses 10 confidence bins.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lcccccc}
        ...
        \midrule
        TN5000 & 0.9540 [0.9381, 0.9676] & 0.8750 & 0.8828 & 0.9559 & 0.7085 & 0.024/0.068 \\
        BUSI & 0.9023 [0.8429, 0.9494] & 0.7115 & 0.8961 & 0.8222 & 0.8214 & 0.104/0.132 \\
        AUL & 0.8752 [0.8114, 0.9276] & 0.7660 & 1.0000 & 1.0000 & 0.6000 & 0.104/0.156 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
\end{table}

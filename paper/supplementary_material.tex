...
\begin{center}
{\Large\bfseries Supplementary Material for ``Localization-Robust Teacher-Student Learning for Mobile Ultrasound Lesion Classification''\par}
\end{center}
\vspace{1em}
...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        Teacher-student localization stress & Strict box-noise, detector-ROI, and full-image report & Teachers and mobile students under matched inputs \\

...
- Near-duplicate pairs by dHash/aHash threshold <= 2: 88
- Cross-split duplicate/near-duplicate pairs: 26
- Label-conflict duplicate/near-duplicate pairs: 6
...
- test_benign_0233 (test, y=0) vs trainval_benign_0299 (trainval, y=0), dHash=1, aHash=0
- test_benign_0235 (test, y=0) vs trainval_benign_0294 (trainval, y=0), dHash=0, aHash=0
- test_benign_0247 (test, y=0) vs trainval_benign_0236 (trainval, y=0), dHash=0, aHash=2
